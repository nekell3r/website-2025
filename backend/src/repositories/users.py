...
from src.schemas.users import UserWithHashedPassword, User, UserAdd # UserAdd для тайпхинта
...
class UsersRepository(BaseRepository):
    ...
    async def get_user_with_hashed_password(self, phone: str) -> UserWithHashedPassword | None:
        ...
        if data.phone:
            if isinstance(data.phone, PydanticPhoneNumber):
                ...
                try:
                    ...
                    phone_to_save = phonenumbers.format_number(parsed_phone, phonenumbers.PhoneNumberFormat.E164)
